...
func (m *MockEquipmentService) GetAll(ctx interface{}) ([]repository.Equipment, error) {
	return m.equipments, m.err
}

func (m *MockEquipmentService) GetByID(ctx interface{}, id int64) (*repository.Equipment, error) {
	return m.equipment, m.err
}

func (m *MockEquipmentService) Create(ctx interface{}, equipment *repository.Equipment) error {
	return m.err
}

func (m *MockEquipmentService) Update(ctx interface{}, equipment *repository.Equipment) error {
	return m.err
}

func (m *MockEquipmentService) Delete(ctx interface{}, id int64) error {
	return m.err
}

func (m *MockEquipmentService) PredictReplacements(ctx interface{}) ([]repository.Equipment, error) {
	return m.equipments, m.err
}
